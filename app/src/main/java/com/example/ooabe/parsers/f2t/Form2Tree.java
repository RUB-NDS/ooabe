/* Generated By:JavaCC: Do not edit this line. Form2Tree.java */
...
public class Form2Tree implements Form2TreeConstants {
    /** Main entry point. */
...
/** Root production. */
  final public String Start(BNode node) throws ParseException {
...
/* Deriviation Rules,  LL(2) Grammar    */
  final public String BFormula(BNode node) throws ParseException {
  String s;
  Token t;
    if (jj_2_1(2)) {
      s = Clause(node);
  ...
  final public String Clause(BNode node) throws ParseException {
 String s="",s1="",s2="";
Token t1;
Token op1;
BNode lc = new BNode();
BNode rc = new BNode();
  ...
  final public String ExpanClause(BNode node) throws ParseException {
  String s, s1;
  Token t;
    if (jj_2_5(2)) {
      t = jj_consume_token(TERM);
  ...
  public Form2TreeTokenManager token_source;
  ...
  public Form2Tree(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Form2Tree(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new Form2TreeTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Form2Tree(java.io.Reader stream) {
  ...
  public Form2Tree(Form2TreeTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(Form2TreeTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
